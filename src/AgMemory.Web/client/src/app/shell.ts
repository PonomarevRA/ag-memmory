...
import type { AppVersion } from '../features/app-version/api.js';
...
export function shell(content: string, path: string, version: AppVersion | null = null): string {

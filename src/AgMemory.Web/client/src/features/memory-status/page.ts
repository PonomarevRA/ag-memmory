...
export async function memoryStatusPage(): Promise<string> {
  ...
  if (state.status !== 'available') return `<section class="memory-status-page"><header class="page-header"><p class="eyebrow">Локальная диагностика</p><h1>Состояние памяти</h1></header><div class="ui-status-banner ui-status-banner--warning"><h2>Состояние памяти недоступно</h2><p>Диагностика доступна только из loopback в Development при явно настроенном локальном scope.</p></div></section>`;
